...
const sharedSequenceStepUtils = window.sequenceStepUtils || {};
const cleanSequenceStepText = sharedSequenceStepUtils.cleanStepText;
if (typeof cleanSequenceStepText !== 'function') {
    throw new Error('Sequence step helper is not available');
}
...
function initSequenceTest(cards) {
    ...
    testSequenceOrder.forEach((card) => {
        ...
        itemDiv.textContent = cleanSequenceStepText(card);
